...
A minimal Bash-based simple interest calculator.
...
This project provides a command-line script that calculates simple interest based on user input.
...
Minor typo fix for merge demo v7.
